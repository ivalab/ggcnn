...
if __name__ == '__main__':
    ...
    test_dataset = Dataset(args.dataset_path_ajd_test, args.dataset_path, start=args.split, end=1.0, ds_rotate=args.ds_rotate,
    ...
    logging.info('Fps: {}'.format(len(test_data) / time_cost))
